...
var FETCH_ADMINS = exports.FETCH_ADMINS = "fecth_admins";

//api here is the axiosInstance in client.js
...
function _asyncToGenerator(fn) { return function () { var gen = fn.apply(this, arguments); return new Promise(function (resolve, reject) { function step(key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { return Promise.resolve(value).then(function (value) { step("next", value); }, function (err) { step("throw", err); }); } } return step("next"); }); }; } // We can use ES6 syntax on our server since we are using webpack and babel
...
var loadData = exports.loadData = function loadData(store) {
  var p = store.dispatch((0, _index.fetchUsers)());
  console.log("functions retuen value--->", p);
  return p;
};
